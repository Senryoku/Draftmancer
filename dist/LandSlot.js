...
export const SpecialLandSlots = {
    ...
    m21: landSlotHandler(BasicLandIDs["m21"], [
    ...
    khm: landSlotHandler(BasicLandIDs["khm"].filter(cid => Cards[cid]["type"].startsWith("Basic Snow")), [
        // Dual Snow Taplands
        "8702d6b9-bb01-4841-a76d-4a576066c772",
        "b20e3117-f1e4-4449-ae9d-0b66abfc717d",
        "9de5fadd-4559-479f-b45d-abe792f0f6e5",
        "682eee5f-7986-45d3-910f-407303fdbcc4",
        "8cff3ef0-4dfb-472e-aa1e-77613dd0f6d8",
        "da1db084-f235-4e26-8867-5f0835a0d283",
        "6611dc5e-6acc-48df-b8c4-4b327314578b",
        "35ebe245-ebb5-493c-b9c1-56fbfda9bd66",
        "f2392fbb-d9c4-4688-b99c-4e7614c60c12",
        "b2dd0b71-5a60-418c-82fc-f13d1b5075d0", // Woodland Chasm
    ], 5 / 12), // Always one snow-covered land, either basic or tapped. Shimmerdrift Vale (f09d98db-0176-41a7-b99b-ead29876cdab) appears in the common slot
};
export const BasicLandSlots = {};
for (let set in BasicLandIDs)
    BasicLandSlots[set] = genBasicLandSlot(set);
