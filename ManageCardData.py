...
constants['PrimarySets'] = [
    s for s in PrimarySets if s in setinfos and s not in ['tsb', 'fmb1', 'afr']]  # Exclude some codes that are actually part of larger sets (tsb, fmb1), or aren't out yet (mh2, afr)
