...
constants['PrimarySets'] = [
    s for s in PrimarySets if s in setinfos and s not in subsets and s not in ["a22", "y22", "j22", "mom", "mat", "cmm"]]  # Exclude some codes that are actually part of larger sets (tsb, fmb1, h1r... see subsets), or aren't out yet
